...
return [
    ...
    */
    ...
    | de posición de los atributos con algo más amigable como "Dirección de correo"
    | en lugar de "email". Esto simplemente nos ayuda a hacer los mensajes más limpios.
    |
    */
